...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('msg', msg);

    /** @ngInject */
    function msg($scope, $rootScope, httpFactory, lotteryConst, custNotify, $filter, common, $uibModal, todoService) {
        ...
        $scope.openEdit = function (edit, item) {
            ...
            open('app/pages/cms/msg/msgEdit.html', 'lg');
        };
    }
})();
