...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('carousel', carousel);

    /** @ngInject */
    function carousel($scope, httpFactory, lotteryConst, custNotify, $uibModal, todoService, common) {
        ...
        $scope.openEdit = function (edit, item) {
            ...
            open('app/pages/cms/content/carousel/carouselEdit.html', 'lg');
        };
    }
})();
