...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('activity', activity);

    /** @ngInject */
    function activity($scope, httpFactory, lotteryConst, custNotify, $uibModal, todoService, common) {
        ...
        $scope.onSearch = function (e) {
            ...
            if ($scope.selectParam.startTime ) {
                $scope.queryParam.beginTime = new Date($scope.selectParam.startTime).getTime();
            }
        ...
        $scope.openEdit = function (edit, item) {
            ...
            if (edit) {
                open('app/pages/cms/activity/activityEdit.html', 'lg');

            } else {
                open('app/pages/cms/activity/activityView.html', 'lg');
            }
        };
    }
})();
