...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('sourceManage', sourceManage);

    /** @ngInject */
    function sourceManage($scope, common, httpFactory, lotteryConst, custNotify, $uibModal) {
