...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('quotaLimitOfficialEdit', quotaLimitOfficialEdit);

    /** @ngInject */
    function quotaLimitOfficialEdit($scope, httpFactory, custNotify, lotteryConst, todoService) {
