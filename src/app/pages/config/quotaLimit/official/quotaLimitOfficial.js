...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('quotaLimitOfficial', quotaLimitOfficial);

    /** @ngInject */
    function quotaLimitOfficial($scope, httpFactory, lotteryConst, custNotify, $uibModal, common, todoService) {
        ...
        $scope.openEdit = function (edit, item) {
            ...
            open('app/pages/config/quotaLimit/official/quotaLimitOfficialEdit.html', 'md');
        };
    }
