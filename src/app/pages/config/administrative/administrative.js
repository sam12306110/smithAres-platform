...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('administrative', administrative);

    /** @ngInject */
    function administrative($scope, httpFactory, lotteryConst, custNotify, $uibModal, todoService, common) {
        ...
        $scope.openEdit = function (edit, item) {
            ...
            open('app/pages/config/administrative/administrativeEdit.html', 'md');
        };
    }
})();
