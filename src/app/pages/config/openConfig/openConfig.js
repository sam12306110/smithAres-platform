...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('openConfig', openConfig);

    /** @ngInject */
    function openConfig($scope, httpFactory, lotteryConst, custNotify, $uibModal, todoService, common) {
        ...
        $scope.openEdit = function (edit, item) {
            ...
            open('app/pages/config/openConfig/openConfigEdit.html', 'md');
        };
    }
})();
