...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('retirement', retirement);

    /** @ngInject */
    function retirement($scope, httpFactory, lotteryConst, custNotify, $uibModal, todoService, common) {
        ...
        $scope.openEdit = function (edit, item) {
            ...
            open('app/pages/config/retirement/retirementEdit.html', 'lg');
        };
    }
})();
