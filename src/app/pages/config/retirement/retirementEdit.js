...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('retirementEdit', retirementEdit);

    /** @ngInject */
    function retirementEdit($scope, httpFactory, lotteryConst, custNotify, todoService, $filter) {
