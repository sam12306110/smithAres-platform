...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('shortLink', shortLink);

    /** @ngInject */
    function shortLink($scope, httpFactory, lotteryConst, custNotify, common, $uibModal, todoService) {
        ...
        $scope.openEdit = function (edit, item) {
            ...
            open('app/pages/config/shortLink/shortLinkEdit.html', 'md');
        };
    }
