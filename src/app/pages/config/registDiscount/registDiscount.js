...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('registDiscount', registDiscount);

    /** @ngInject */
    function registDiscount($scope, httpFactory, lotteryConst, custNotify, $uibModal, todoService, common) {
        ...
        $scope.openEdit = function (edit, item) {
            ...
            open('app/pages/config/registDiscount/registDiscountEdit.html', 'md');
        };
    }
})();
