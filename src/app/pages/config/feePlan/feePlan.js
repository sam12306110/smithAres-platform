...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('feePlan', feePlan);

    /** @ngInject */
    function feePlan($scope, httpFactory, lotteryConst, custNotify, $uibModal, todoService, common) {
        ...
        $scope.openEdit = function (edit, item) {
            ...
            open('app/pages/config/feePlan/feePlanEdit.html', 'md');
        };
    }
})();
