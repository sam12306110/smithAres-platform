...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('agentPeriod', agentPeriod);

    /** @ngInject */
    function agentPeriod($scope, httpFactory, lotteryConst, custNotify, $uibModal, todoService, common) {
        ...
        $scope.openEdit = function (edit, item) {
            ...
            open('app/pages/config/agentPeriod/agentPeriodEdit.html', 'md');
        };
    }
})();
