...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('periodManageOfficialEdit', periodManageOfficialEdit);

    /** @ngInject */
    function periodManageOfficialEdit($scope, httpFactory, lotteryConst, custNotify) {
        ...
        $scope.onSave = function () {
            ...
            httpFactory.getList(url + '/save', 'POST', null, saveData).then(function (data) {
