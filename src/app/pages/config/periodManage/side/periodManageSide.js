...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('periodManageSide', periodManageSide);

    /** @ngInject */
    function periodManageSide($scope, httpFactory, lotteryConst, common, custNotify, $uibModal, todoService) {
        ...
        $scope.openEdit = function (edit, item) {
            ...
            //     item: item
            // };
            open('app/pages/config/periodManage/side/periodManageSideEdit.html', 'md');
        };
    }
})();
