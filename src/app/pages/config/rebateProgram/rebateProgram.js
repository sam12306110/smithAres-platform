...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('rebateProgram', rebateProgram);

    /** @ngInject */
    function rebateProgram($scope, httpFactory, lotteryConst, custNotify, $uibModal, todoService, common) {
