...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('domain', domain);

    /** @ngInject */
    function domain($scope, httpFactory, lotteryConst, custNotify, $uibModal, todoService, common) {
        ...
        function initPage() {
            $scope.selectParam = {
                ...
                domainTypeSelected: {id: null, value: '请选择'}
            };
            $scope.queryParam = {
                page: 1,//当前页*分页必须
        ...
        $scope.onSearch = function (e) {
            ...
            if ($scope.selectParam.domainTypeSelected) {
                $scope.queryParam.type = $scope.selectParam.domainTypeSelected.id;
            }
        ...
        $scope.openEdit = function (edit, item) {
            ...
            open('app/pages/config/domain/domainEdit.html', 'lg');
        };
    }
})();
