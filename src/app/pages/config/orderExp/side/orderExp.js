...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('orderExpSide', orderExpSide);

    /** @ngInject */
    function orderExpSide($scope, $rootScope, httpFactory, common, lotteryConst, custNotify, $uibModal, orderExpVarHolderSide) {
        $scope.pageSize = 20;


        $scope.selectParam = {
            lottery: [],
            status: orderExpVarHolderSide.status,
        ...
        $rootScope.onOrderExpSearch = function (e) {
            ...
            var testUrl1 = orderExpVarHolderSide.getOrderExpResourcePath() + '/list';
        ...
        $scope.onStatus = function (lotteryId, status) {
            ...
            httpFactory.getList(orderExpVarHolderSide.getOrderExpResourcePath() + '/updateOrderExpStatus', 'GET', null, queryParamForSearch).then(function (data) {
        ...
        $scope.modifyOrderExp = function (modify, item) {
            orderExpVarHolderSide.modify = modify;
            orderExpVarHolderSide.item = item;
            $scope.open("app/pages/config/orderExp/side/orderExpUpdate.html", "md");
        }
    }
})();