...
(function () {
    ...
    angular.module('BlurAdmin.pages').service('riskOfficialConfigVarHolder', riskOfficialConfigVarHolder);

    /** @ngInject */
    function riskOfficialConfigVarHolder(lotteryConst) {
        ...
        //t
        this.actions = {
            clickRiskOrderCtrl: "clickRiskOrderCtrl",
            clickHostileOrderCtrl: "clickHostileOrderCtrl",
        }
    }
})();
