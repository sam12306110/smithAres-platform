...
(function () {
    ...
    //管理中`心ip
    angular.module('BlurAdmin.pages').controller('hostileSideOrderCtrl', hostileSideOrderCtrl);

    /** @ngInject */
    function hostileSideOrderCtrl($scope, httpFactory, riskSideConfigVarHolder,
        ...
        $scope.search = function (page) {
            ...
            httpFactory.getList(riskSideConfigVarHolder.listHostileRecordURL(),
                'GET',
                null,
                queryParamForSearch
        ...
        $scope.$on(riskSideConfigVarHolder.actions.clickHostileOrderCtrl, function () {
            $scope.selectPage(1);
        })
