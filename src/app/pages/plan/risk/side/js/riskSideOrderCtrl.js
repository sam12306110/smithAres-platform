...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('riskSideOrderCtrl', riskSideOrderCtrl);


    function riskSideOrderCtrl($scope, httpFactory, riskSideConfigVarHolder, custNotify,
        ...
        $scope.search = function (page) {
            ...
            httpFactory.getList(riskSideConfigVarHolder.listRiskOrderURL(),
                'GET',
                null,
                queryParamForSearch
        ...
        $scope.getStatusList = function () {
            httpFactory.getList(riskSideConfigVarHolder.getRiskOrderStatusListURL(),
                'GET',
                null,
                null
            ).then(function (result) {
        ...
        $scope.exportForRiskOrder = function () {
            ...
            httpFactory.getList(riskSideConfigVarHolder.exportRiskOrderURL(),
                'GET',
                null,
                queryParamForSearch
            ).then(function (result) {
         ...
         * 接收时间
         */
        $scope.$on(riskSideConfigVarHolder.actions.clickRiskOrderCtrl, function () {
            $scope.selectPage(1);
        })
        ...
        $scope.onLock = function (item) {
            ...
            //锁定
            updateParam.status = riskSideConfigVarHolder.riskOrderStatus.LOCKED;
        ...
        $scope.onAudit = function (item) {
            riskSideConfigVarHolder.auditItem = item;
            riskSideConfigVarHolder.refreshMethod = $scope.refresh;
            $scope.open("app/pages/plan/risk/side/riskSideAudit.html", "md");
        }
