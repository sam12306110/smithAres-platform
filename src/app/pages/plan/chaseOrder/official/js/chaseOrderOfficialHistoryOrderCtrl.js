...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('chaseOrderOfficialHistoryOrderCtrl', chaseOrderOfficialHistoryOrderCtrl);


    function chaseOrderOfficialHistoryOrderCtrl($scope, httpFactory,
        ...
        $scope.getQueryParam = function (page) {
            ...
            if (condition.betStartTime == null ||
                condition.betStartTime == undefined) {
                throw "没有选择开始时间";
            }
            if (condition.betEndTime == null ||
                condition.betEndTime == undefined) {
                throw "没有选择结束时间";
            }
        ...
        $scope.search = function (page) {
            ...
            try {
                ...
                httpFactory.getList(chaseOrderOfficialConfigVarHolder.getHistoryChaseOrderListURL(),
                    'GET',
                    null,
                    queryParamForSearch
                    ...
                    if (result.code != null
                        ...
                        && result.msg != null) {
                        custNotify.error(result.reasonForShow, result.msg);
                        return;
                    }
                    custNotify.error(lotteryConst.msgSelect.fail,  '提示:');
                });
        ...
        $scope.export = function () {
            ...
            httpFactory.getList(chaseOrderOfficialConfigVarHolder.getHistoryChaseOrderExportURL(),
                'GET',
                null,
                queryParamForSearch
            ).then(function (result) {
        ...
        $scope.onReset = function () {
            ...
            $scope.viewParam.selectedStatus = null;
            $scope.viewParam.betStartTime = null;
            $scope.viewParam.betEndTime = null;
        };
