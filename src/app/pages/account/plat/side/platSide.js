...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('platSideCtrl', platSideCtrl);

    /** @ngInject */
    function platSideCtrl($scope, $rootScope, httpFactory, lotteryConst, custNotify, $uibModal, common) {
        ...
        $rootScope.onSearch = function (e) {
            ...
            httpFactory.getList(lotteryConst.aresAccount + '/platinfo/list?sideType=2', 'GET', null, $scope.queryParam).then(function (data) {
