...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('manualDrawInfo', manualDrawInfo);

    /** @ngInject */
    function manualDrawInfo($scope, httpFactory, lotteryConst, custNotify, $uibModal, todoService, common,$filter) {
