...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('olineFlowInfo', olineFlowInfo);

    /** @ngInject */
    function olineFlowInfo($scope, httpFactory, lotteryConst, custNotify, $uibModal, todoService, common,$filter) {
        var url = lotteryConst.payConfigPath + '/member/online/statList';
