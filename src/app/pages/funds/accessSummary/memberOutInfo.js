...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('memberOutInfo', memberOutInfo);

    /** @ngInject */
    function memberOutInfo($scope, httpFactory, lotteryConst, custNotify, $uibModal, todoService, common,$filter) {
        var url = lotteryConst.payConfigPath + '/member/draw/statList';
