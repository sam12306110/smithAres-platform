...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('giveDiscountInfo', giveDiscountInfo);

    /** @ngInject */
    function giveDiscountInfo($scope, httpFactory, lotteryConst,  todoService, common,$filter) {
