...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('manualFlowInfo', manualFlowInfo);

    /** @ngInject */
    function manualFlowInfo($scope, httpFactory, lotteryConst, custNotify, $uibModal, todoService, common,$filter) {
