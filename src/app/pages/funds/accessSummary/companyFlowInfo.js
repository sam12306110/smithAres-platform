...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('companyFlowInfo', companyFlowInfo);

    /** @ngInject */
    function companyFlowInfo($scope, httpFactory, lotteryConst, custNotify, $uibModal, todoService, common,$filter) {
        var url = lotteryConst.payConfigPath + '/member/offline/statList';
