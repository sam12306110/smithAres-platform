...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('memberOutFlowInfo', memberOutFlowInfo);

    /** @ngInject */
    function memberOutFlowInfo($scope, httpFactory, lotteryConst, custNotify, $uibModal, todoService, common,$filter) {
        var url = lotteryConst.paymentPlatPath + '/chargeanddraw/statList';
