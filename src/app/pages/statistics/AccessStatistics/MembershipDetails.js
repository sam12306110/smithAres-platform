...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('MembershipDetails', MembershipDetails);

    /** @ngInject */
    function MembershipDetails($scope, httpFactory, lotteryConst, custNotify, $interval, todoService, common, $sce) {
        ...
        function initPage() {
            $scope.selectParam = {
                ...
                depositType:[{id: null, value: '全部'}].concat(lotteryConst.deposit),
        ...
        $scope.onSearch = function (e) {
            ...
            httpFactory.getList( url+'/momey/statistics/inList', 'GET', null, $scope.queryParam).then(function (result) {
                if(result.data){
