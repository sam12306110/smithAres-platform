...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('membersHierarchicalStatistics', membersHierarchicalStatistics);

    /** @ngInject */
    function membersHierarchicalStatistics($scope, httpFactory, lotteryConst,  todoService, common, $uibModal) {
        ...
        $scope.gogogo = function (e) {
           if(!e.levelName){
                ...
                todoService.set(
                    {
                        ...
                        memberLevelSelected:e.levelId,
                        lotterySelected:e.lotteryId
                    }
                );
            ...
            window.location.href = '#/statistics/memberNoteStatistics'
        };
        /**
         * 条件搜索
         */
        ...
        $scope.onSearch = function (e) {
            ...
            if ($scope.selectParam.lotterySelected) {
                ...
                for (var o = 0; o < $scope.selectParam.lotterySelected.length; o++) {
                    tt.push($scope.selectParam.lotterySelected[o].id)
                }
            ...
            httpFactory.getList(url + '/levelStatistics/list', 'GET', null, $scope.queryParam).then(function (result) {
