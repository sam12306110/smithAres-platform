...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('MemberDiscountStatistics', MemberDiscountStatistics);

    /** @ngInject */
    function MemberDiscountStatistics($scope, httpFactory, lotteryConst, custNotify, $interval, todoService, common, $sce) {
        ...
        function initPage() {
            $scope.selectParam = {
                statusSelected:{id: null, value:'全部优惠'},
         ...
         */
         $scope.onSearch = function (e) {
            ...
            httpFactory.getList(url + '/momey/statistics/discount/agent', 'GET', null, $scope.queryParam).then(function (result) {
                if(result.data){
         ...
         $scope.gogogo = function (e) {
            ...
            if($scope.selectParam.startTime&&$scope.selectParam.endTime){
                ...
                window.localStorage.setItem('agentName',e.agentName)
             ...
             window.location.href = '#/statistics/MemberBenefitsList'
         };
