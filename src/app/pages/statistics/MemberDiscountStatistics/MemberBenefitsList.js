...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('MemberBenefitsList', MemberBenefitsList);

    /** @ngInject */
    function MemberBenefitsList($scope, httpFactory, lotteryConst, custNotify, $interval, todoService, common, $sce) {
        ...
        $scope.gogogo = function (e) {
            ...
            if($scope.selectParam.startTime&&$scope.selectParam.endTime){
                ...
                window.location.href = '#/statistics/MemberDiscountDetails'
        };
        //时间
