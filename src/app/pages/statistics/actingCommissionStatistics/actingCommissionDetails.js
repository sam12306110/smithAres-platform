...
(function () {
    'use strict';
    angular.module('BlurAdmin.pages').controller('actingCommissionDetails', actingCommissionDetails);

    /** @ngInject */
    function actingCommissionDetails($scope, httpFactory, lotteryConst, custNotify, todoService, $filter) {
        ...
        $scope.onSearch = function (e) {
            ...
            httpFactory.getList(url + 'agent/r_com/month_bill_detail', 'GET', null, $scope.queryParam).then(function (result) {
                if(result.data){
