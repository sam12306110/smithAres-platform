...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('actingCommissionStatistics', actingCommissionStatistics);

    /** @ngInject */
    function actingCommissionStatistics($scope, httpFactory, lotteryConst, todoService, common, $sce) {
