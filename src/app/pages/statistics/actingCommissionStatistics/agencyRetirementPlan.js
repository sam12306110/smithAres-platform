...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('agencyRetirementPlan', agencyRetirementPlan);

    /** @ngInject */
    function agencyRetirementPlan($scope, httpFactory, lotteryConst, custNotify, todoService, $filter) {
