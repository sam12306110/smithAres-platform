...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('actingMonthlyEdit', actingMonthlyEdit);

    /** @ngInject */
    function actingMonthlyEdit($scope, httpFactory, lotteryConst, custNotify, todoService, $filter) {
