...
(function () {
    ...
    angular.module('BlurAdmin.pages').controller('creditRecordSide', creditRecordSide);

    /** @ngInject */
    function creditRecordSide($scope, httpFactory, lotteryConst, $uibModal, todoService, common) {
